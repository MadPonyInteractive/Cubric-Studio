...
export const ICONS = {
    ...
    // Sampling a colour off the screen (the GIF cut-out's By colour key).
    'eyedropper': '<path d="M17.66 5.41l.92.92-2.69 2.69-.92-.92 2.69-2.69M17.67 3c-.26 0-.51.1-.71.29l-3.12 3.12-1.93-1.91-1.41 1.41 1.42 1.42L3 16.34V21h4.66l8.41-8.41 1.42 1.42 1.41-1.41-1.92-1.92 3.12-3.12c.4-.4.4-1.03.01-1.42l-2.34-2.34c-.2-.19-.45-.29-.7-.29zM6.83 19L5 17.17l8.17-8.17 1.83 1.83L6.83 19z"/>',
