...
Derived from `plan.md` phase titles at `todo -> doing`.

- [x] the swap: an inference becomes a preference
- [x] the picker, and the key field — built and driven live; the DESKTOP key field
