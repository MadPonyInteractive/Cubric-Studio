...
- **Status (2026-09-14 15:10):** planned, nothing implemented; handed off (`state/handoffs/a7bbe2a4…`). MPI-752 committed again at ec780dd4 and still claims `MpiModelManager.js`/`.css`.
