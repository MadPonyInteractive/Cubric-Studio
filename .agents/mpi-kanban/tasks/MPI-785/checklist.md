...
- [x] Pick a shape from the menu, see that shape saved to project.json
- [x] Old heart-favourited cards show a dot
- [x] FILTER panel "Only" lists Dots, Squares, Triangles, Previews
- [x] Media picker shows the same FILTER button and panel instead of the type tabs
