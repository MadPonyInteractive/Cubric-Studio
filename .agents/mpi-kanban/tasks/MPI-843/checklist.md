...
- [x] Three mockups of the agent chat panel, built on the real BEM structure and the real
      design tokens, for Fabio to evaluate.
- [x] Each one answers: where Cosmo sits, whether a terminal aesthetic holds up against the
...
Ships no app code. Mockups are standalone HTML for evaluation and deliberately do NOT use
ComponentFactory or the component system.
