...
- [x] A DeepInfra models section at the FOOT of the library
- [x] Out of the installed/available counts, and out of the hero stats
- [x] A paid chip with a price, never an Install button
