...
- [ ] Fix 8 (MpiFlowLibrary, MpiModelManager, MpiRunpodSettings, MpiLlmSettings -> Organisms; MpiRemote -> Blocks; MpiOllamaSetup stays): waits for MPI-754 Phase 3 (session 6ebab8b3, live claim on MpiModelManager.js/.css). Layout decided (Fabio 2026-09-15): FLAT, e.g. `Organisms/MpiFlowLibrary/`, `Blocks/MpiRemote/`; the other LandingPages (MpiAbout, MpiSettings, MpiOllamaSetup, mpi-hotkeys) stay put. One pass after MPI-754 commits Phase 3 (it also edits the MpiFlowLibrary typedef in types.js)
