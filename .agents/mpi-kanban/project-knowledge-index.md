...
- **Read first:** `.claude/skills/cubric-vision-generate/SKILL.md` § "Dispatching a generation", `docs/generation-lifecycle.md` § "An agent is the THIRD producer"
